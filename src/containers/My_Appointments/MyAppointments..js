...
import '../My_Appointments/myappointments.css';
        ...
        <div>
            <div className="bg-success jumbotron rounded-corner-jumbo-clinics">
                    ...
                    <div className="row">
                        ...
                        <div className="col">
                            <p className="fw-lighter mt-3 fs-5" >My Appointments</p>
                        </div>
                    </div>
                </div>
            </div>
            <div className="">
                <center className="container">
                    <div className="row my-appointments-margin">
                        <Link className="col my-appt-underline">
                            <div className=" border p-2 bg-success appt-text">Current</div>
                        </Link>
                        <Link className="col my-appt-underline " to={"/appointments/history"}>
                            <div className="col border p-2 history-color border-success">History</div>
                        </Link>
                    </div>
                </center>
            </div>
            <div className="card mt-5 mx-3 shadow rounded">
                <div className="row ">
                    ...
                    <div className="col p-2">
                        ...
                        <center className="container">
                            <div className="row">
                                <div className="col p-1 bg-success m-1 appt-text rounded">Reschedule</div>
                                <div className="col p-1 bg-warning m-1 rounded">Cancel</div>
                                <div className="col p-1 add-to-his appt-text m-1 rounded">{"+ "}History</div>
                            </div>
                        </center>
                    </div>
                </div>
